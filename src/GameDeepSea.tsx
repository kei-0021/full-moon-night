...
import type { PlayerWithResources, ResourceId } from "react-game-ui";
...
// サーバーのURLを環境変数を使って設定
// プロダクション環境では空の文字列または undefined を使用し、
// useSocket.ts 側で window.location.origin を使用するようにする
const SOCKET_URL = import.meta.env.PROD 
    ? '' // プロダクションでは空文字列を渡し、useSocket側でオリジンを使う
    : "http://127.0.0.1:4000"; // 開発環境用

export default function App() {
  // 修正箇所: ハードコードされたURLを、環境変数で切り替わる SOCKET_URL に置き換える
