...
export default function Game() {
  ...
  const renderBoard = () => {
    switch (activeBoard) {
      case "forest":
        return <RadialBoardCanvas theme="forest" pieces={pieces} setPieces={setPieces} />;
      case "moon":
        return <RadialBoardCanvas theme="moon" pieces={pieces} setPieces={setPieces} />;
      case "lake":
        return <RadialBoardCanvas theme="lake" pieces={pieces} setPieces={setPieces} />;
      default:
        return null;
    }
  };
